...
func wsHandler(w http.ResponseWriter, r *http.Request) {
	...
	if len(params["Login"]) > 0 { playerName = params["Login"][0] }
	if len(params["ServerName"]) > 0 { room_rules.ServerName = params["ServerName"][0] }
	if len(params["ConnectTypeName"]) > 0 { room_rules.ConnectTypeName = params["ConnectTypeName"][0] }
